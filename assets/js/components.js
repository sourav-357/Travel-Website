(function(){
  function renderHeader(){
    ...
    header.innerHTML = [
      ...
      '    <a class="btn btn--primary" href="packages.html">Get started</a>',
      '  </div>',
      '</div>'
    ].join('');
  ...
  function renderFooter(){
    ...
    footer.innerHTML = [
      ...
      '      <p style="max-width:42ch">Premium, curated travel made effortless — transparent pricing, expert support, unforgettable experiences.</p>',
      '    </div>',
      '    <div>',
      '      <h4>Explore</h4>',
      '      <p><a href="destinations.html">Destinations</a></p>',
      '      <p><a href="packages.html">Packages</a></p>',
      '      <p><a href="blog.html">Stories</a></p>',
      '    </div>',
      '    <div>',
      '      <h4>Company</h4>',
      ...
      '    <small>Crafted for discerning travelers worldwide</small>',
      '  </div>',
      '</div>'
    ].join('');
